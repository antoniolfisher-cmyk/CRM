                    ...
                    <div className="flex gap-1 items-center">
                      {p.asin && (
                        <a
                          ...
                          className="btn-ghost py-1 px-1.5 text-xs text-gray-400 hover:text-blue-600 hover:bg-blue-50 flex items-center"
        ...
        <div>
          ...
          {(form.asin || '').length === 10 && (
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="mt-1 inline-flex items-center gap-1.5 text-xs text-gray-500 hover:text-blue-600 hover:bg-blue-50 border border-gray-200 rounded px-2 py-0.5 transition-colors"
            >
