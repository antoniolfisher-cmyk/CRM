...
// ─── Wholesale Dashboard ──────────────────────────────────────────────────────
// Contains Amazon live sales tiles + open orders panels (moved from Dashboard)
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-500 text-sm mt-1">Amazon sales, orders, and account balance — live</p>
      </div>
      <AmazonSalesPanel />
      <AmazonOrdersPanel />
    </div>
